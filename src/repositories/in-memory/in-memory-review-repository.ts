...
//         const userIndex = this.userRepository.items.findIndex(
//             (user) => user.id === data.reviewedId
//         )

//         if(userIndex >= 0) {
//             this.userRepository.items[userIndex]?.avgRating = new Prisma.Decimal(average)
//         }
